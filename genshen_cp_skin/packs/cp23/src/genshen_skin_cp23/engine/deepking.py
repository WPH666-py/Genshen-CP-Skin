...
def pkg_root():
    """包目录 .../genshen_skin_cp23(本模块在它的 engine/ 下, 故向上一层)。
...
# src/client/genshen-cp23.module.css 完全一致的取值, 保证在线转换与离线生成一致。
...
FALLBACK_CSS = """:root {
  ...
  --bg-layer-2: #f7efe6;
  --bg-layer-3: #ead9c9;
  --label-primary: #2e211c;
  --label-secondary: #57413a;
  --label-tertiary: #8b736a;
  --brand-primary: #b03a35;
  --accent: #b03a35;
  --primary: #b03a35;
  --interactive-bg-hover-solid: #f6e2dd;
  --interactive-bg-active: #ecc8c0;
  --border-l1: #edded1;
  --border-l2: #d8c1ae;
  --border: #d8c1ae;
}
        ...
        <section class="mock" style="background:%(bg)s;color:%(bgText)s">
          ...
          <div class="body">
            <aside style="background:%(sidebarBg)s;color:%(sidebarText)s;border-color:%(border)s">
              ...
              <div class="item">📁 Genshen-skin-CP23</div>
...
<h2>🌙 暗色 Dark</h2>%(dark)s
        ...
        "light": region(p, "亮色 · 原神CP23", mascot.get("light")),
        "dark": region(d, "暗色 · 原神CP23", mascot.get("dark")),
    }
