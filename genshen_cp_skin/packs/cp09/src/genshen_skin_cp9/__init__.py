...
两张素材 x 三种摆法(共 6 种壁纸) / 桌面桌宠 / 多 IDE 皮肤 / DeepKing 界面皮肤

    import genshen_skin_cp9 as gs
...
包名 genshen-skin-cp9 / 命令 genshen-cp9 / 运行时目录 ~/.genshen-cp9,
两个套件可同时安装、各自切换。
"""
from .characters.cp9_pair import (  # noqa: F401
    APP_DIR,
    APP_NAME,
    APP_SLUG,
    DEFAULT_MODE,
