...
def pkg_root():
    """包目录 .../genshen_skin_cp21(本模块在它的 engine/ 下, 故向上一层)。
...
# src/client/genshen-cp21.module.css 完全一致的取值, 保证在线转换与离线生成一致。
...
FALLBACK_CSS = """:root {
  ...
  --bg-layer-2: #f3ede0;
  --bg-layer-3: #e5dcc7;
  --label-primary: #212a24;
  --label-secondary: #48564c;
  --label-tertiary: #7b8a7e;
  --brand-primary: #3f7d78;
  --accent: #3f7d78;
  --primary: #3f7d78;
  --interactive-bg-hover-solid: #dfeae6;
  --interactive-bg-active: #c4d9d3;
  --border-l1: #e2e2d5;
  --border-l2: #c9cdb8;
  --border: #c9cdb8;
}
        ...
        <section class="mock" style="background:%(bg)s;color:%(bgText)s">
          ...
          <div class="body">
            <aside style="background:%(sidebarBg)s;color:%(sidebarText)s;border-color:%(border)s">
              ...
              <div class="item">📁 Genshen-skin-CP21</div>
...
<h2>🌙 暗色 Dark</h2>%(dark)s
        ...
        "light": region(p, "亮色 · 原神CP21", mascot.get("light")),
        "dark": region(d, "暗色 · 原神CP21", mascot.get("dark")),
    }
